...
#define GG 9.8															// 重力加速?
/* 现在量程设定为±6g */
#define MPU_ACCE_M_S_2 (3.0 * GG / 32768.0) //单位换算，将LSB化为m/(s^2)，GG前面的"X"需根据量程修改
...
/*!***************************************************
 * @file: MYGYROData.c
 * @brief:获取yaw轴角度调用这个函数就可以
 * @note:
 ****************************************************/
void IMU_GetValue(void);
//BMI088.yaw 和 BMI088.yawsum 可能会用到
//BMI088.gyro_z 暂时不清楚，试一试
