...
#define MOTOR_PID_SPEED_KP    5.0f
#define MOTOR_PID_SPEED_KI    0.3f
#define MOTOR_PID_SPEED_KD    0.0f
#define MOTOR_PID_POSITION_KP    5.0f
#define MOTOR_PID_POSITION_KI    0.3f
#define MOTOR_PID_POSITION_KD    0.0f
#define MOTOR_PID_DEADBAND    0.0f      //暂时未用到
#define MOTOR_PID_MAX_OUT    16000.0f
